 ...
 * @since 2.2.0
 */
public final class RedisSessionMapper implements Function<Map<String, Object>, MapSession> {
     ...
     */
    public static final String ATTRIBUTE_PREFIX = "sessionAttr:";

    private final String sessionId;

    public RedisSessionMapper(String sessionId) {
